...
public class Main {
    public static void main(String[] args) {
        ...
        library.borrowBook("bob@example.com", "978-0134685991");
        ...
        // Remove a book
        library.removeBook("978-0134685992");
        ...
        // Update a patron
        library.updatePatron("bob@example.com", "Robert Smith", "robert.smith@example.com");

        // Final list after updates
        library.getAvailableBooks();
        library.getBorrowedBooks();
    }
}
